    ...
    <main className={styles.page}>
      <div className={`card ${styles.shell}`} data-hero-item>
        <aside className={styles.visual}>
          ...
          <div className={styles.benefits}><div><KeyRound size={17} /> One-time reset code</div><div><LockKeyhole size={17} /> Choose a new password</div><div><ShieldCheck size={17} /> Account protection</div></div>
        </aside>
        <section className={styles.form}>
          <h1>Reset password</h1>
          <p className="muted">We will send a short-lived code if the account exists.</p>
          <div className={styles.mobileTrust}><LockKeyhole size={19} /> Reset your password and return to your account securely.</div>
          <ForgotPasswordForm />
        </section>
      </div>
    </main>
